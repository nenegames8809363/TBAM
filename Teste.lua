...
--// TBAM
--// STABLE EDITION v2.8.2
--// AERO ADMIN / TEST PANEL
--//
--// REBUILT / VERIFIED EDITION
--// • HOME / DASHBOARD
--// • MOVEMENT
--// • FUN
--// • VISUAL
...
local function CreateToast(
	...
	if not ToastContainer
		or not ToastContainer.Parent then
		return
	end
...
local function SetTrollTargetInternal(
	...
	if not target
		or not isValidTrollTarget(target) then
...
--// =========================================================
--// FIX:
--// O loop NÃO é desconectado quando o botão é desligado.
--// Ele apenas ignora o trabalho enquanto State.Rainbow == false.
